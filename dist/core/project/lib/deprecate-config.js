...
remap("command.add.includeFilteredDependencies", "command.add.includeDependencies", {
  ...
  alsoRoot: true
}), remap("command.publish.ignore", "command.publish.ignoreChanges"), remap("commands", "command"), (config, filepath) => ({
  config,
  filepath
}));
/**
