...
function verifyNpmPackageAccess(packages, username, options) {
  ...
  function failure(err) {
    ...
    if (err.code === "E500" || err.code === "E404") {
      ...
      opts.log.warn("EREGISTRY", "Registry %j does not support `npm access ls-packages`, skipping permission checks...", // registry
      opts.registry); // don't log redundant errors
