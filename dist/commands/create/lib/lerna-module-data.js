...
const niceName = rudeName => rudeName.replace(/^node-|[.-]js$/g, "").replace(" ", "-").toLowerCase();
...
exports.name = this.yes ? name : this.prompt("package name", niceName(name), data => {
...
exports.version = this.yes ? version : this.prompt("version", version, data => {
...
if (!this.package.keywords) {
  ...
  exports.keywords = this.yes ? keywords : this.prompt("keywords", keywords, data => {
    if (!data) {
      return undefined;
    }
...
exports.license = this.yes ? license : this.prompt("license", license, data => {
