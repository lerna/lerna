        ...
        <div className="row">
          <div className="col col--8 margin-vert--xl">
            ...
            <p className={styles.description}>
              Lerna is the standard tool for managing and publishing versioned Javascript packages from a same
              repository.
            </p>
            <div className="padding-vert--md row">
              <div className="col col--5">
                <a href="#" className="button button--lg button--block button--primary">
                  Get Started
                </a>
              </div>
              <div className="col col--5">
