...
describe("PublishCommand", () => {
  ...
  /** =========================================================================
   * NORMAL - UDPATE VERSION
   * ======================================================================= */

  describe("normal mode with --update-version repo", () => {
    let testDir;
  ...
  describe("normal mode with --update-version package", () => {
    let testDir;
  ...
  describe("independent mode with --update-version canary", () => {
    let testDir;
